    ...
    'regex/invalid': [
      ...
      [
        ...
        },
        {
          regex: '@/styles',
          replacement: '@styles',
          message: 'Use \'@styles\' path alias for importing styles from \'resources/ts/styles\'',
        },
        ...
        },
        {
          ...
          message: 'Use axios instances created in \'resources/ts/plugin/axios.ts\' instead of unconfigured axios',
          files: {
